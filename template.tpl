...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Enhencer - Product Page",
  ...
  "description": "This tag has to fire after the product detail page loaded successfully.",
  "containerContexts": [
    "WEB"
  ]
}
...
const productPage = ()=>{
  let cons = callInWindow('enhencerCollector.productPage', {productCategory: data.productCategory, price: data.productPrice, productID: data.productID});
            ...
            "listItem": [
              ...
              },
              {
                ...
                "mapValue": [
                  {
                    "type": 1,
                    "string": "enhencerCollector.productPage"
                  },
                  {
                    "type": 8,
                    "boolean": true
...
Created on 6/1/2021, 4:12:24 PM
